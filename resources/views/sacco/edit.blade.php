...
@section('content')
    <h1 class="text-muted text-center">EDIT VEHICLE</h1>
    {!! Form::model($vehicle, ['method'=>'PATCH', 'action'=> ['SaccoVehicleController@update', $vehicle->id]]) !!}
    <div class="row">
        <div class="col-2"></div>
        <div class="col-8">
    ...
    <div class="row">
        ...
        <div class="col-8">
            <div class="info-box">
                <div class="info-box-content">
                    <div class="form-group">
                        {!! Form::submit('Submit', ['class'=>'btn btn-outline-info btn-block','onclick'=>'myFunction()']) !!}
                    </div>
                </div>
                <!-- /.info-box-content -->
            </div>
    ...
    <div class="row">
        <div class="col-2"></div>
        <div class="col-8">
            {!! Form::open(['method'=>'DELETE', 'action'=> ['SaccoVehicleController@destroy', $vehicle->id]]) !!}

            <div class="form-group">
                {!! Form::submit('Delete Vehicle', ['class'=>'btn btn-outline-danger btn-block']) !!}
            </div>
