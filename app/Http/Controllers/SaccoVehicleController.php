...
class SaccoVehicleController extends Controller
{
    ...
    public function store(VehicleAddRequest $request)
    {
        ...
        if (Auth::check()){
            ...
            $vehicle['vehicle_registration_number'] = str_replace(' ', '', $vehicle['vehicle_registration_number']);
            $vehicle['vehicle_registration_number'] = strtoupper($vehicle['vehicle_registration_number']);
